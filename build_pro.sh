...
export CLANG_PATH=$BASE_PATH/clang-9/bin
...
export LD_LIBRARY_PATH=$BASE_PATH/clang-9/lib:$LD_LIBRARY_PATH

echo
echo "Set DEFCONFIG"
echo 
make CC="ccache clang" O=out_pro stock_kona_pro_defconfig
...
make CC="ccache clang" O=out_pro -j4
